...
[assembly: SuppressMessage("Style", "IDE0161:Convertir en namespace con ámbito de archivo", Justification = "<pendiente>", Scope = "namespace", Target = "~N:GtMotive.Estimate.Microservice.Domain.Interfaces")]
